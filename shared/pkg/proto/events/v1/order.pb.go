...
// ShipAssembled событие завершения постройки корабля
...
const file_events_v1_order_proto_rawDesc = "" +
	...
	"order_uuid\x18\x02 \x01(\tR\torderUuid\x12\x1b\n" +
	"\tuser_uuid\x18\x03 \x01(\tR\buserUuid\x12$\n" +
	"\x0ebuild_time_sec\x18\x04 \x01(\x03R\fbuildTimeSecBHZFgithub.com/dfg007star/go_rocket/assembly/pkg/proto/events/v1;events_v1b\x06proto3"
