...
func (o OptOrderDtoPaymentMethod) Encode(e *jx.Encoder) {
	if !o.Set {
		return
	}
...
func (o *OptOrderDtoPaymentMethod) Decode(d *jx.Decoder) error {
	if o == nil {
		return errors.New("invalid: unable to decode OptOrderDtoPaymentMethod to nil")
	}
	o.Set = true
...
// MarshalJSON implements stdjson.Marshaler.
func (s OptOrderDtoPaymentMethod) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// UnmarshalJSON implements stdjson.Unmarshaler.
func (s *OptOrderDtoPaymentMethod) UnmarshalJSON(data []byte) error {
	d := jx.DecodeBytes(data)
	return s.Decode(d)
}
