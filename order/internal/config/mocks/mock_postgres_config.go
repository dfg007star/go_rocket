...
// MigrationDirectory provides a mock function with no fields
func (_m *PostgresConfig) MigrationDirectory() string {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for MigrationDirectory")
	}
...
// PostgresConfig_MigrationDirectory_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'MigrationDirectory'
type PostgresConfig_MigrationDirectory_Call struct {
	*mock.Call
}

// MigrationDirectory is a helper method to define mock.On call
func (_e *PostgresConfig_Expecter) MigrationDirectory() *PostgresConfig_MigrationDirectory_Call {
	return &PostgresConfig_MigrationDirectory_Call{Call: _e.mock.On("MigrationDirectory")}
}

func (_c *PostgresConfig_MigrationDirectory_Call) Run(run func()) *PostgresConfig_MigrationDirectory_Call {
...
func (_c *PostgresConfig_MigrationDirectory_Call) Return(_a0 string) *PostgresConfig_MigrationDirectory_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *PostgresConfig_MigrationDirectory_Call) RunAndReturn(run func() string) *PostgresConfig_MigrationDirectory_Call {
	_c.Call.Return(run)
	return _c
}
